...
import '../../../apis/renterd/bus/host_api.dart';
...
class HosterImpl implements HosterAbst {
  ...
  Future<http.Response> getHostInfoByPublicKey({
    ...
    http.Response _response = await http.get(
      Uri.parse(
        getHostInfoByPublicKeyApi(publicKey, serverAddress),
      ),
      headers: {
        HttpHeaders.contentTypeHeader: "application/json",
        HttpHeaders.authorizationHeader:
  ...
  Future<http.Response> getHostScannig({
    ...
    http.Response _response = await http.get(
      Uri.parse(
        getHostsScanningApi(offset, limit, lastScan, serverAddress),
      ),
      headers: {
        HttpHeaders.contentTypeHeader: "application/json",
        HttpHeaders.authorizationHeader:
  ...
  Future<http.Response> postInteraction(
    ...
    http.Response _response = await http.post(
        Uri.parse(
          postInteractionApi(serverAddress),
        ),
        headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader:
  ...
  Future<http.Response> updateAllowList({
    ...
    http.Response _response = await http.put(
        Uri.parse(
          updateAllowListApi(serverAddress),
        ),
        headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader:
  ...
  Future<http.Response> updateBlockList({
    ...
    http.Response _response = await http.put(
        Uri.parse(
          updateBlockListApi(serverAddress),
        ),
        headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader:
  ...
  Future<http.Response> fetchSomeHost({
    ...
    http.Response _response = await http.get(
      Uri.parse(
        fetchSomeHostApi("gouging", serverAddress),
      ),
      headers: {
        HttpHeaders.contentTypeHeader: "application/json",
        HttpHeaders.authorizationHeader:
  ...
  Future<http.Response> updateSomeHost({
    ...
    http.Response _response = await http.put(
        Uri.parse(
          updateSomeHostApi("gouging", serverAddress),
        ),
        headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader:
