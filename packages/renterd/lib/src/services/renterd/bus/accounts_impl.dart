...
import '../../../apis/renterd/bus/account_api.dart';
...
class AccountsImpl implements AccountsAbst {
  ...
  Future<http.Response> getAllAccounts({
    ...
    http.Response _response = await http.get(
      Uri.parse(getAccountsApi(serverAddress)),
      headers: {
  ...
  Future<http.Response> addDeposit({
    ...
    http.Response _response =
        await http.post(Uri.parse(addDepositApi(accountId, serverAddress)),
            headers: {
              HttpHeaders.contentTypeHeader: "application/json",
              HttpHeaders.authorizationHeader:
                  "Basic ${base64Encode(utf8.encode('$username:$password'))}"
  ...
  Future<http.Response> getAnAccountById({
    ...
    http.Response _response = await http.post(
        Uri.parse(getAnAccountByIdApi(accountId, serverAddress)),
        headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader:
              "Basic ${base64Encode(utf8.encode('$username:$password'))}"
  ...
  Future<http.Response> lockAnAccount({
    ...
    http.Response _response =
        await http.post(Uri.parse(lockAnAccountApi(accountId, serverAddress)),
            headers: {
              HttpHeaders.contentTypeHeader: "application/json",
              HttpHeaders.authorizationHeader:
                  "Basic ${base64Encode(utf8.encode('$username:$password'))}"
  ...
  Future<http.Response> resetDrift({
    ...
    http.Response _response = await http.post(
      Uri.parse(resetDriftApi(accountId, serverAddress)),
      headers: {
        HttpHeaders.contentTypeHeader: "application/json",
        HttpHeaders.authorizationHeader:
            "Basic ${base64Encode(utf8.encode('$username:$password'))}"
  ...
  Future<http.Response> syncBalance({
    ...
    http.Response _response =
        await http.post(Uri.parse(syncBalanceApi(accountId, serverAddress)),
            headers: {
              HttpHeaders.contentTypeHeader: "application/json",
              HttpHeaders.authorizationHeader:
                  "Basic ${base64Encode(utf8.encode('$username:$password'))}"
  ...
  Future<http.Response> unLockAnAccount({
    ...
    http.Response _response =
        await http.post(Uri.parse(unLockAnAccountApi(accountId, serverAddress)),
            headers: {
              HttpHeaders.contentTypeHeader: "application/json",
              HttpHeaders.authorizationHeader:
                  "Basic ${base64Encode(utf8.encode('$username:$password'))}"
  ...
  Future<http.Response> updateBalance({
    ...
    http.Response _response =
        await http.post(Uri.parse(updateBalanceApi(accountId, serverAddress)),
            headers: {
              HttpHeaders.contentTypeHeader: "application/json",
              HttpHeaders.authorizationHeader:
                  "Basic ${base64Encode(utf8.encode('$username:$password'))}"
