...
import '../../../apis/renterd/bus/contracts_api.dart';
...
class ContractImpl implements ContractAbst {
  ...
  Future<http.Response> acquireAContract({
    ...
    http.Response _response = await http.post(
      Uri.parse(acquireAContractApi(id, serverAddress)),
      headers: {
  ...
  Future<http.Response> addContract({
    ...
    http.Response _response = await http.post(
      Uri.parse(postContractsApi(id, serverAddress)),
      headers: {
        HttpHeaders.contentTypeHeader: "application/json",
        HttpHeaders.authorizationHeader:
            "Basic ${base64Encode(utf8.encode('$username:$password'))}"
  ...
  Future<http.Response> deleteContractById({
    ...
    http.Response _response = await http.delete(
      Uri.parse(deleteContractByIdApi(id, serverAddress)),
      headers: {
        HttpHeaders.contentTypeHeader: "application/json",
        HttpHeaders.authorizationHeader:
            "Basic ${base64Encode(utf8.encode('$username:$password'))}"
  ...
  Future<http.Response> getContractById({
    ...
    http.Response _response = await http.get(
      Uri.parse(getContractByIdApi(id, serverAddress)),
      headers: {
        HttpHeaders.contentTypeHeader: "application/json",
        HttpHeaders.authorizationHeader:
            "Basic ${base64Encode(utf8.encode('$username:$password'))}"
  ...
  Future<http.Response> getContracts({
    ...
    http.Response _response = await http.get(
      Uri.parse(getContractsApi(serverAddress)),
      headers: {
        HttpHeaders.contentTypeHeader: "application/json",
        HttpHeaders.authorizationHeader:
            "Basic ${base64Encode(utf8.encode('$username:$password'))}"
  ...
  Future<http.Response> releasePreviousContract({
    ...
    http.Response _response = await http.post(
      Uri.parse(releasePreviousContractApi(id, serverAddress)),
      headers: {
        HttpHeaders.contentTypeHeader: "application/json",
        HttpHeaders.authorizationHeader:
            "Basic ${base64Encode(utf8.encode('$username:$password'))}"
