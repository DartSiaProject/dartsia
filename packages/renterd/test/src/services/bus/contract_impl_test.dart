...
import 'package:renterd/src/apis/renterd/bus/contracts_api.dart';
import 'package:renterd/src/services/renterd/bus/contract_impl.dart';
...
void main() async {
  ...
  group('ContractImpl => ', () {
    ...
    test(
      ...
      () async {
        http.Response _response = await http.get(
          Uri.parse(getContractsApi(_serverAddress)),
          headers: {
            HttpHeaders.contentTypeHeader: "application/json",
            HttpHeaders.authorizationHeader:
                "Basic ${base64Encode(utf8.encode('$_username:$_password'))}"
