...
import 'package:renterd/src/apis/renterd/bus/consensus_api.dart';
import 'package:renterd/src/services/renterd/bus/consensus_impl.dart';
...
void main() async {
  ...
  group('ConsensusImpl => ', () {
    ...
    test(
      ...
      () async {
        http.Response _response = await http.post(
          Uri.parse(postAcceptBlockApi(_serverAddress)),
          headers: {
    ...
    test(
      ...
      () async {
        http.Response _response = await http.get(
          Uri.parse(getTotalPayoutApi(100000000, _serverAddress)),
          headers: {
            HttpHeaders.contentTypeHeader: "application/json",
            HttpHeaders.authorizationHeader:
                "Basic ${base64Encode(utf8.encode('$_username:$_password'))}"
    ...
    test(
      ...
      () async {
        http.Response _response = await http.get(
          Uri.parse(getStateApi(_serverAddress)),
          headers: {
            HttpHeaders.contentTypeHeader: "application/json",
            HttpHeaders.authorizationHeader:
                "Basic ${base64Encode(utf8.encode('$_username:$_password'))}"
