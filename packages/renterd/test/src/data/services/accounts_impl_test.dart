...
import 'package:renterd/src/data/services/accounts_impl.dart';
  ...
  group('AccoutsImpl =>', () {
    ...
    test(
      ...
      () async {
        ...
        final verifyValue =
            await _accountsImpl.getAllAccounts(password: 'renterd');
    ...
    test(
      ...
      () async {
        ...
        http.Response _response = await http.post(
            Uri.parse(
                "${dotenv.env['ROOT_URL']}${getAnAccountByIdApi("ed25519:99611c808ccb74402f0c80ea0b22cefe3b46a73abe1072c90687658d44dead75")}"),
            headers: {
              HttpHeaders.contentTypeHeader: "application/json",
              HttpHeaders.authorizationHeader:
                  "Basic ${base64Encode(utf8.encode('$username:$password'))}"
    ...
    test(
      ...
      () async {
        ...
        http.Response _response = await http.post(
            Uri.parse(
                "${dotenv.env['ROOT_URL']}${lockAnAccountApi("ed25519:99611c808ccb74402f0c80ea0b22cefe3b46a73abe1072c90687658d44dead75")}"),
            headers: {
              HttpHeaders.contentTypeHeader: "application/json",
              HttpHeaders.authorizationHeader:
                  "Basic ${base64Encode(utf8.encode('$username:$password'))}"
    ...
    test(
      ...
      () async {
        ...
        http.Response _response = await http.post(
          Uri.parse(
              "${dotenv.env['ROOT_URL']}${resetDriftApi("ed25519:99611c808ccb74402f0c80ea0b22cefe3b46a73abe1072c90687658d44dead75")}"),
          headers: {
            HttpHeaders.contentTypeHeader: "application/json",
            HttpHeaders.authorizationHeader:
                "Basic ${base64Encode(utf8.encode('$username:$password'))}"
    ...
    test(
      ...
      () async {
        ...
        http.Response _response = await http.post(
            Uri.parse(
                "${dotenv.env['ROOT_URL']}${unLockAnAccountApi("ed25519:99611c808ccb74402f0c80ea0b22cefe3b46a73abe1072c90687658d44dead75")}"),
            headers: {
              HttpHeaders.contentTypeHeader: "application/json",
              HttpHeaders.authorizationHeader:
                  "Basic ${base64Encode(utf8.encode('$username:$password'))}"
    ...
    test(
      ...
      () async {
        ...
        http.Response _response = await http.post(
            Uri.parse(
                "${dotenv.env['ROOT_URL']}${updateBalanceApi("ed25519:99611c808ccb74402f0c80ea0b22cefe3b46a73abe1072c90687658d44dead75")}"),
            headers: {
              HttpHeaders.contentTypeHeader: "application/json",
              HttpHeaders.authorizationHeader:
                  "Basic ${base64Encode(utf8.encode('$username:$password'))}"
    ...
    test(
      ...
      () async {
        ...
        http.Response _response = await http.post(
            Uri.parse(
                "${dotenv.env['ROOT_URL']}${syncBalanceApi("ed25519:99611c808ccb74402f0c80ea0b22cefe3b46a73abe1072c90687658d44dead75")}"),
            headers: {
              HttpHeaders.contentTypeHeader: "application/json",
              HttpHeaders.authorizationHeader:
                  "Basic ${base64Encode(utf8.encode('$username:$password'))}"
    ...
    test(
      ...
      () async {
        ...
        http.Response _response = await http.post(
            Uri.parse(
                "${dotenv.env['ROOT_URL']}${addDepositApi("ed25519:99611c808ccb74402f0c80ea0b22cefe3b46a73abe1072c90687658d44dead75")}"),
            headers: {
              HttpHeaders.contentTypeHeader: "application/json",
              HttpHeaders.authorizationHeader:
                  "Basic ${base64Encode(utf8.encode('$username:$password'))}"
